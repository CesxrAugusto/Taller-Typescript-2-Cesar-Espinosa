...
const tabla = document.getElementById("tabla-series");
const promedio = document.getElementById("promedio-seasons");
let numeroSeries = 0;
let temporadasTotal = 0;
let average = 0;
